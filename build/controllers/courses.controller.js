...
exports.updateCourseById = exports.requestEnrollment = exports.handleEnrollmentRequest = exports.getPendingRequests = exports.getCourses = exports.getCourseById = exports.deleteCourseById = exports.createCourse = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _Courses["default"].find().populate('division', 'name').populate('professor', 'name email');
        case 3:
...
var createCourse = exports.createCourse = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, name, description, divisionName, duration, isActive, professorEmail, division, professor, professorRole, newCourse, savedCourse;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 14:
          professorRole = _context2.sent;
          if (professor.roles.includes(professorRole._id)) {
            _context2.next = 17;
            break;
          }
          return _context2.abrupt("return", res.status(400).json({
  ...
  return function createCourse(_x3, _x4) {
...
var updateCourseById = exports.updateCourseById = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var courseId, _req$body2, name, description, divisionName, duration, isActive, professorEmail, division, professor, professorRole, updatedCourse;
  ...
  return function updateCourseById(_x7, _x8) {
...
var deleteCourseById = exports.deleteCourseById = /*#__PURE__*/function () {
  ...
  return function deleteCourseById(_x9, _x10) {
...
var requestEnrollment = exports.requestEnrollment = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var courseId, studentId, course, student, studentRole, newRequest, savedRequest;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 13:
          studentRole = _context6.sent;
          if (student.roles.includes(studentRole._id)) {
            _context6.next = 16;
            break;
          }
  ...
  return function requestEnrollment(_x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();

// Obtener solicitudes pendientes para un curso (Solo Profesor)
var getPendingRequests = exports.getPendingRequests = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var courseId, course, professorId, pendingRequests;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 12:
          pendingRequests = _context7.sent;
  ...
  return function getPendingRequests(_x13, _x14) {
...
var handleEnrollmentRequest = exports.handleEnrollmentRequest = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var requestId, status, request, professorId, updatedRequest;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 8:
          // Verificar que el usuario sea un profesor del curso
          professorId = req.userId; // Asume que el ID del profesor se obtiene del token
          if (request.course.professor.equals(professorId)) {
            _context8.next = 11;
            break;
          }
  ...
  return function handleEnrollmentRequest(_x15, _x16) {
